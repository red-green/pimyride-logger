...
SENSORS = [
	...
	Sensor("load", "Calculated Load Value", "0104", percent_scale, "%"),  # TODO: if this breaks, change PID back to 01041
	...
	Sensor("fuel_pressure", "Fuel Pressure", "010A", cpass, "kPa"),
	...
	Sensor("fuel_type", "Fuel Type", "0151", pid151, ""),
	Sensor("fuel_rail_pressure", "Fuel rail pressure", "0123", FuelRailPressD, "kPa"),
	Sensor("fuel_rate", "Engine fuel rate ", "015E", pid15e, "L/h"),
	Sensor("mpg","Miles per Gallon", "0120", cpass, "mpg"),   #this one is a dummy to accomidate the 'fake' mpg reading
	Sensor("pressure","Barometric pressure","0133",hex_to_int,"kPa"),
]
